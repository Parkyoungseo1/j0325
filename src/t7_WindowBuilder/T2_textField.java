...
public class T2_textField extends JFrame {
	...
	public T2_textField() {
		...
		txtPwd.setBounds(210, 91, 275, 41);
		pn2.add(txtPwd);
		
		JLabel lblimage = new JLabel("");
		lblimage.setIcon(new ImageIcon(T2_textField.class.getResource("/t7_WindowBuilder/images/16.jpg")));
		//lblimage.setIcon(new ImageIcon( "D:\\javaclass\\java\\works\\j0325_AWT_Swing_windowBuilder\\myimages\\1.jpg"));
		//lblimage.setIcon(new ImageIcon("./myImages/1.jpg"));    // 이건가능
		...
		btnExit.setIcon(new ImageIcon(T2_textField.class.getResource("/t7_WindowBuilder/images/Exit.jpg")));
		btnExit.setFont(new Font("굴림", Font.PLAIN, 18));
		btnExit.setBounds(398, 5, 118, 40);
		pn3.add(btnExit);
